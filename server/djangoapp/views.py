...
# Creating a `login_request` view to handle sign in request
@csrf_exempt
...
# Creating a `logout_request` view to handle sign out request
...
# # Updating the 'get_cars' view to get cars make and model
...
# Creating a `get_dealer_reviews` view to render the reviews of a dealer
...
# Creating a `add_review` view to submit a review
...
# Creating a `get_inventory` view to get a car inventory details
